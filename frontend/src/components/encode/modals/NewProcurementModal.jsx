                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="field-group">
                            ...
                            <select value={form.app_type} onChange={(e) => updateFormField('app_type', e.target.value)} className="input-field font-bold">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="field-group">
                            ...
                            <input type="text" value={form.market_period_from} onChange={(e) => updateFormField('market_period_from', e.target.value)} className="input-field" placeholder="MM/YY" />
                        </div>
                        <div className="field-group">
                            <label className="label">Period To</label>
                            <input type="text" value={form.market_period_to} onChange={(e) => updateFormField('market_period_to', e.target.value)} className="input-field" placeholder="MM/YY" />
                        </div>
                    </div>
                    <div className="field-group">
