                        ...
                        <form onSubmit={handleAddUserSubmit} className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="input-field w-full"
                                    placeholder="e.g. Procurement, BAC Secretariat"
                                    disabled={submitting}
                                    required
                                />
                            </div>
                        ...
                        <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
                            ...
                            <div className="flex items-center gap-4 pt-1">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    >
                                        <span
                                            className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${editForm.is_active ? 'translate-x-5' : 'translate-x-1'}`}
                                        />
                                    </button>
