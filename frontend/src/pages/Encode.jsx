...
const Encode = ({ user }) => {
    ...
    useEffect(() => {
        if (activeModal === 'new' && newStep === 'form') {
            ...
            documentService.getNextTransactionNumber().then(setNextTransactionNumber).catch(() => setNextTransactionNumber('—'));
        }
    }, [activeModal, newStep]);
    ...
    const performNewSubmit = async () => {
        ...
        try {
            ...
            // Transaction number is auto-generated by the backend (not sent)
                    ...
                    <div className="card-elevated max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl rounded-2xl border-0">
                        ...
                        {newStep === 'form' && (
                            <form onSubmit={handleNewSubmit} className="p-6 space-y-5">
                                ...
                                {/* Fill Out Procurement Details: Title, Transaction Number (auto-filled), Date */}
                                <div>
