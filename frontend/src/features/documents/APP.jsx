                                    ...
                                    <tr key={idx} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-all duration-300 group">
                                        <td className="px-8 py-5 align-middle">
                                            <div className="flex flex-col overflow-hidden">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-0.5 truncate">Annual Procurement Plan</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-5 align-middle text-center">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <span className="text-[10px] font-bold text-slate-300 uppercase tracking-tighter">Verified System Log</span>
                                            </div>
                                        </td>
